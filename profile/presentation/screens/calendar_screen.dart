import 'package:alquilafacil/profile/presentation/widgets/event_type_indicator.dart';
import 'package:alquilafacil/profile/presentation/widgets/highlighted_calendar_day.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text("Toca en una fecha para ver más detalles sobre la programación", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
              ...
              calendarBuilders: CalendarBuilders(
                ...
                markerBuilder: (context, day, events) {
                  if (redDays.contains(day)) {
                    ...
                    return HighlightedCalendarDay(day:day, color: Colors.amberAccent);
                  }
                  return null;
                },
              ),
