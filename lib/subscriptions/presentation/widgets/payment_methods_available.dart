    ...
    return Row(
      ...
      children: [
        PaymentMethodCard(
            ...
            onPaymentStart: (){
              Navigator.push(context, MaterialPageRoute(builder: (_) => PaymentSubscription(planPrice: planProvider.currentPlans[0].price, planId: planProvider.currentPlans[0].id, planName: planProvider.currentPlans[0].name)));
            }
        ),
      ],
    );
