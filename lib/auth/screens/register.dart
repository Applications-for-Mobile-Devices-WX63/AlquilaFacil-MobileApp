           ...
           child: Center(
             child: Column(
               children: <Widget> [
                 ...
                 const SizedBox(height: 10),
                 AuthTextField(textLabel: "Número de Telefono", textHint: "Ingrese su número de telefono", isPassword: false),
                 const SizedBox(height: 10),
                 AuthTextField(textLabel: "Número de documento", textHint: "Ingrese su número de documento", isPassword: false),
                 const SizedBox(height: 10),
